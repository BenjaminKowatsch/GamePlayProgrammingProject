...
//        m_system.initialize(32, FMOD_STUDIO_INIT_LIVEUPDATE, FMOD_INIT_NORMAL, nullptr)            // enable fmod studio live update
    ...
    g_globalManager.getResourceManager()->registerResourceType(pDummySoundLibrary);
    g_globalManager.getResourceManager()->registerResourceType(m_pDummySound);
    g_globalManager.getResourceManager()->registerResourceType(m_pDummySoundInstance);
}
