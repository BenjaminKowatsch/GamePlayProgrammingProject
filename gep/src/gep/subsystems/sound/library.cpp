...
gep::IFmodSoundLibraryLoader::IFmodSoundLibraryLoader(const char* resourceId) :
...
gep::FmodSoundLibraryFileLoader::FmodSoundLibraryFileLoader(const char* filename) :
    IFmodSoundLibraryLoader(filename)
{
}
...
gep::FmodSoundLibrary* gep::FmodSoundLibraryFileLoader::loadResource(FmodSoundLibrary* pInPlace)
{
    ...
    pInPlace->unload();
    pInPlace->load(m_resourceId.c_str());
    return pInPlace;
}
...
gep::FmodDummySoundLibraryLoader::FmodDummySoundLibraryLoader() : 
	IFmodSoundLibraryLoader("<Dummy FmodSoundLibrary>")
{
