...
logMessage("\tcreating ship")
ship = createShip("ship")
logMessage("\tship created")
...
logMessage("\tcreating laser")
laser = createLaser("laser")
logMessage("\tlaser created")
...
logMessage("\tcreating asteroid")
asteroid = createAsteroid("asteroid")
logMessage("\tasteroid created")
...
logMessage("Finished initializing game.")
